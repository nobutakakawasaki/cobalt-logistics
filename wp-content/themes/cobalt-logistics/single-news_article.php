<?php
/**
 * Single template for the `news_article` custom post type
 * (NEWS_COLUMN_CPT_MIGRATION_BRIEF.md #9). Always links back to the
 * お知らせ listing page — no category branching needed (that's the whole
		...
		<section class="section">
			<div class="container article-body">
				...
				<p class="article-body__back">
					<a href="<?php echo esc_url( cobalt_logistics_page_url( 'news' ) ); ?>">&larr; お知らせ一覧に戻る</a>
				</p>
